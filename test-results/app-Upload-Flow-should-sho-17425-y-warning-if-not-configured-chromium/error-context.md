...
- Name: app.spec.ts >> Upload Flow >> should show API key warning if not configured
- Location: tests/app.spec.ts:81:3
...
Locator: getByText(/Vui lòng cấu hình Deepgram API key/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Vui lòng cấu hình Deepgram API key/)
...
- banner:
  - button "arrow_back"
  - heading "Upload Audio" [level=1]
- main:
  - text: cloud_upload
  - paragraph: Drag & drop audio file here
  - paragraph: or tap to browse
  - paragraph: MP3, M4A, WAV, WEBM, OGG • Max 10MB
- text: Step 1 of 2
- button "close"
- text: key
- heading "Let's set up your API key" [level=1]
- paragraph: One-time setup to enable audio transcription.
- heading "Configuration Steps" [level=3]
- text: "1"
- paragraph: Go to deepgram.com
- paragraph: Create a free account.
- text: "2"
- paragraph: Generate & Copy Key
- paragraph: Create an API key.
- text: "3"
- paragraph: Paste below
- paragraph: Unlock transcription.
- text: Your Deepgram API Key
- textbox "dg_a7b2..."
- button "visibility"
- text: info
- paragraph: 12,000 free minutes/year • Stored locally
- button "Save & Continue arrow_forward" [disabled]
- link "Get Free Key →":
